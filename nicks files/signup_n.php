...
$error='';
		...
		else 
		{
			...
			$dsn = 'mysql:host=localhost;dbname=owleats';
...
<div id="container">
	<div id="signup_menu" align="center"><p id="title">OwlEats<p>
		...
		<form id="signupform" class="signupform"  method="post" action="">
			...
			<input type="" name="firstname" id="firstname" value="" size="20" maxlength="20">
			</tr>
			...
			<input type="" name="lastname" id="lastname" value="" size="20" maxlength="20">
			</tr>
			...
			<input type="text" name="phonenumber" id="phonenumber" value="" size="20" maxlength="20"> 
			</tr>
			...
			<input type="text" name="username" id="username" value="" size="20" maxlength="20"> 
			</tr>
		...
		<button><a id="backBtn" href="owleats_home.php">Return to Homepage</a></button>	
